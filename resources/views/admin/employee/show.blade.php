										...
										<div class="card-body p-0">
											<div class="row py-8 px-8 py-lg-15 px-lg-10">
												<div class="col-xl-12 col-xxl-12">
													...
													<!--begin::Wizard Form-->
													<form class="form fv-plugins-bootstrap fv-plugins-framework" method="post" action="{{route('admin.employee.update',$employee->id)}}" id="kt_form" enctype="multipart/form-data">
														@csrf
														@method('PATCH')
																	...
																	<div class="col-xl-6">
																		...
																		<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" 	name="emp_no" type="text" value="{{$employee->emp_no}}" placeholder="{{__('site.emp_no')}}">
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" 	name="official_email" type="email" value="{{$employee->official_email}}" placeholder="{{__('site.official_email')}}">
																					<div class="fv-plugins-message-container"></div>
																				</div>
																			</div>
																			<!--end::Group-->
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" 	name="phone" type="text" value="{{$employee->phone}}" placeholder="{{__('site.phone')}}">
																					<div class="fv-plugins-message-container"></div>
																				</div>
																			</div>
																			<!--end::Group-->
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" 	name="emergency_contact" type="text" value="{{$employee->emergency_contact}}" placeholder="{{__('site.emergency_contact')}}">
																					<div class="fv-plugins-message-container"></div>
																				</div>
																			</div>
																			<!--end::Group-->
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<select class="form-control form-control-solid form-control-lg" name="location"><option value="">Select</option>
																						...
																						<option {{$employee->location == 'dubai' ? 'selected' : ''}} value="dubai">Dubai</option>
																						<option {{$employee->location == 'saudi' ? 'selected' : ''}} value="saudi">Saudi Arabia</option>
																						{{$employee->address}}
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input type="date" name="date_of_join" class="form-control form-control-solid form-control-lg" value="{{$employee->date_of_join}}">
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<select class="form-control form-control-solid form-control-lg" name="visa_status">
																						...
																						<option {{$employee->visa_status == 'visit' ? 'selected' : ''}} value="visit">Visit Visa</option>
																						<option {{$employee->visa_status == 'residence' ? 'selected' : ''}} value="residence">Residence Visa</option>
																						<option {{$employee->visa_status == 'sponcer' ? 'selected' : ''}}  value="sponcer">Sponcers</option>
																					</select>
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input type="date" name="visa_exp" class="form-control form-control-solid form-control-lg" value="{{$employee->visa_exp}}">
																		...
																		<!--begin::Group-->
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input type="date" name="passport_issue" class="form-control form-control-solid form-control-lg" value="{{$employee->passport_issue}}">
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" 	name="emirates_id" type="text" value="{{$employee->emirates_id}}" placeholder="{{__('site.emirates_id')}}">
																					<div class="fv-plugins-message-container"></div>
																				</div>
																			</div>
																			<!--end::Group-->
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input type="date" name="emiratesid_exp" class="form-control form-control-solid form-control-lg" value="{{$employee->emiratesid_exp}}">
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" 	name="labour_card_issue" type="date" value="{{$employee->labourcard_issue}}" placeholder="{{__('site.labour_card_issue')}}">
																					<div class="fv-plugins-message-container"></div>
																				</div>
																			</div>
																			<!--end::Group-->
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" 	name="insurance_issue" type="date" value="{{$employee->insurance_issue}}" placeholder="">
																					<div class="fv-plugins-message-container"></div>
																				</div>
																			</div>
																			<!--end::Group-->
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" 	name="reporting_manager" type="text" value="{{$employee->reporting_manager}}" placeholder="{{__('site.reporting_manager')}}">
																					<div class="fv-plugins-message-container"></div>
																				</div>
																			</div>
																			<!--end::Group-->
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<select class="form-control form-control-solid form-control-lg" name="department">
																						...
																						<option {{$employee->department == 'marking' ? 'selected' : ''}} value="marking">Marketing</option>
																						<option {{$employee->department == 'admin' ? 'selected' : ''}}  value="admin">Admin</option>
																						<option {{$employee->department == 'hr' ? 'selected' : ''}} value="hr">HR</option>
																						<option {{$employee->department == 'it' ? 'selected' : ''}} value="it">IT</option>
																					</select>
																	...
																	<div class="col-xl-6">
																		...
																		<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" 	name="employee_name" type="text" value="{{$employee->employee_name}}" placeholder="{{__('site.employee_name')}}">
																					<div class="fv-plugins-message-container"></div>
																				</div>
																			</div>
																			<!--end::Group--> 
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" 	name="personel_email" type="email" value="{{$employee->personel_email}}" placeholder="{{__('site.personel_email')}}">
																					<div class="fv-plugins-message-container"></div>
																				</div>
																			</div>
																			<!--end::Group-->
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" 	name="alternative_phone" type="text" value="{{$employee->alternative_phone}}" placeholder="{{__('site.alternative_phone')}}">
																					<div class="fv-plugins-message-container"></div>
																				</div>
																			</div>
																			<!--end::Group-->
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<textarea name="home_address" class="form-control">{{$employee->home_address}}</textarea>
																					<div class="fv-plugins-message-container"></div>
																				</div>
																			</div>
																			<!--end::Group-->
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" 	name="emergency_phone" type="text" value="{{$employee->emergency_phone}}" placeholder="{{__('site.emergency_phone')}}">
																					<div class="fv-plugins-message-container"></div>
																				</div>
																			</div>
																			<!--end::Group-->
													...
													<option {{$employee->country_id == $country->id ? 'selected' : ''}} value="{{$country->id}}" data-select2-id="{{$country->id}}">{{$country->name}}</option>
												@endforeach
																					</select>
                                                                        ...
                                                                        <!--begin::Group-->
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input type="date" name="date_of_birth" value="{{$employee->date_of_birth}}" class="form-control form-control-solid form-control-lg">
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input type="date" name="visa_issue" class="form-control form-control-solid form-control-lg" value="{{$employee->visa_issue}}">
                                                                            ...
                                                                            <div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" 	name="passport_no" type="text" value="{{$employee->passport_no}}" placeholder="{{__('site.passport_no')}}">
																					<div class="fv-plugins-message-container"></div>
																				</div>
																			</div>
																			<!-- end:Group -->
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input type="date" name="passport_exp" class="form-control form-control-solid form-control-lg" value="{{$employee->passport_exp}}">
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input type="date" name="emirates_id_issue" class="form-control form-control-solid form-control-lg" value="{{$employee->emirates_id_issue}}">
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" 	name="labour_card" type="text" value="{{$employee->labour_card}}" placeholder="{{__('site.labour_card')}}">
																					<div class="fv-plugins-message-container"></div>
																				</div>
																			</div>
																			<!--end::Group-->
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" 	name="insurance_card" type="text" value="{{$employee->insurance_card}}" placeholder="{{__('site.insurance_card')}}">
																					<div class="fv-plugins-message-container"></div>
																				</div>
																			</div>
																			<!--end::Group-->
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" 	name="insurance_card_exp" type="date" value="{{$employee->insurance_card_exp}}" placeholder="{{__('site.labour_card_exp')}}">
																					<div class="fv-plugins-message-container"></div>
																				</div>
																			</div>
																			<!--end::Group-->
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" 	name="designation" type="text" value="{{$employee->designation}}" placeholder="{{__('site.designation')}}">
																					<div class="fv-plugins-message-container"></div>
																				</div>
																			</div>
																			<!--end::Group-->
																	...
																	<div class="col-xl-6">
																		...
																		<!--begin::Group-->
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					@if($employee->photo)
																				<a href="{{$employee->photo}}" target="_blank" download="download">Download</a>
																			@endif
																		...
																		<!--begin::Group-->
																			<div class="form-group row fv-plugins-icon-container">
																				<label class="col-xl-3 col-lg-3 col-form-label">{{__('site.passport_no')}}</label>
																				<div class="col-lg-9 col-xl-9">
																					@if($employee->doc_passport)
																				<a href="{{$employee->doc_passport}}" target="_blank" download="download">Download</a>
																			@endif
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					@if($employee->doc_visa)
																				<a href="{{$employee->doc_visa}}" target="_blank" download="download">Download</a>
																			@endif
                                                                         ...
                                                                         <!--begin::Group-->
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					@if($employee->doc_labour_card)
																				<a href="{{$employee->doc_labour_card}}" target="_blank" download="download">Download</a>
																			@endif
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					@if($employee->doc_education)
																				<a href="{{$employee->doc_education}}" target="_blank" download="download">Download</a>
																			@endif
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																						@if($employee->doc_pre_exp)
																				<a href="{{$employee->doc_pre_exp}}" target="_blank" download="download">Download</a>
																			@endif
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																				@if($employee->mol_contract)
																				<a href="{{$employee->mol_contract}}" target="_blank" download="download">Download</a>
																			@endif
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																				@if($employee->commission_letter)
																				<a href="{{$employee->commission_letter}}" target="_blank" download="download">Download</a>
																			@endif
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																				    	@if($employee->warning_letter)
																				<a href="{{$employee->warning_letter}}" target="_blank" download="download">Download</a>
																			@endif
																	...
																	<div class="col-xl-6">
																		...
																		<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<a href="{{$employee->offer_letter}}" target="_blank" download="download">Download</a>
																			@endif
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				<label class="col-xl-3 col-lg-3 col-form-label">{{__('site.emirates_id')}}</label>
																				<div class="col-lg-9 col-xl-9">
																					@if($employee->doc_emirates_id)
																				<a href="{{$employee->doc_emirates_id}}" target="_blank" download="download">Download</a>
																			   @endif
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<a href="{{$employee->medical_certificate}}" target="_blank" download="download">Download</a>
																			   @endif
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																				@if($employee->doc_insurance_card)
																				<a href="{{$employee->doc_insurance_card}}" target="_blank" download="download">Download</a>
																			   @endif
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																				@if($employee->resume)
																				<a href="{{$employee->resume}}" target="_blank" download="download">Download</a>
																			   @endif
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					@if($employee->doc_pre_visa)
																				<a href="{{$employee->doc_pre_visa}}" target="_blank" download="download">Download</a>
																			   @endif
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					@if($employee->increment_letter)
																				<a href="{{$employee->increment_letter}}" target="_blank" download="download">Download</a>
																			   @endif
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<a href="{{$employee->resignation_letter}}" target="_blank" download="download">Download</a>
																			   @endif
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																				@if($employee->tremination_letter)
																				<a href="{{$employee->tremination_letter}}" target="_blank" download="download">Download</a>
																			   @endif
																	...
																	<div class="col-xl-6">
																		...
																		<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" 	name="basic_salary" type="text" value="{{$employee->basic_salary}}" placeholder="{{__('site.basic_salary')}}">
																					<div class="fv-plugins-message-container"></div>
																				</div>
																			</div>
																			<!--end::Group-->
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" 	name="hra" type="text" value="{{$employee->hra}}" placeholder="{{__('site.hra')}}">
																					<div class="fv-plugins-message-container"></div>
																				</div>
																			</div>
																			<!--end::Group-->
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" 	name="other_allowance" type="text" value="{{$employee->other_allowance}}" placeholder="{{__('site.other_allowance')}}">
																					<div class="fv-plugins-message-container"></div>
																				</div>
																			</div>
																			<!--end::Group-->
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" 	name="total_salary" type="text" value="{{$employee->total_salary}}" placeholder="{{__('site.total_salary')}}">
																					<div class="fv-plugins-message-container"></div>
																				</div>
																			</div>
																			<!--end::Group-->
