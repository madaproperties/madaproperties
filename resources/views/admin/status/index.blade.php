...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content" style="padding-top:10px">
								...
								<div class="d-flex flex-row">
									...
									<div class="card-header border-0 py-5">
										<h3 class="card-title align-items-start flex-column">
											<span class="card-label font-weight-bolder text-dark"> {{__('site.status')}}</span>
											<span class="text-muted mt-3 font-weight-bold font-size-sm">{{count($status)}} {{__('site.status')}}</span>
										</h3>
										...
										<div class="table-responsive">
											<table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_1">
												<thead>
													<tr class="text-left">
														...
														<th style="min-width: 150px">{{ __('site.weight') }}</th>
												...
												<tbody>
													...
													<tr>
														...
														<td class="pl-0">
															<span class="text-muted font-weight-bold text-muted d-block">{{$statu->name_ar}}</span>
														</td>
														<td>
															<span class="text-muted font-weight-bold">{{$statu->name_en}}</span>
														</td>
														<td>
															<span class="text-muted font-weight-bold">{{$statu->weight}}</span>
														</td>
														<td>
									        ...
									        <div class="modal-content">
									            ...
									            <div class="modal-body">
																<form class="form" method="post" id="edit-{{$statu->id}}-form" action="{{route('admin.status.update',$statu->id)}}">
																	@csrf
																	@method('PUT')
																	<div class="card-body">
																		<div class="form-group">
																			<label>{{__('site.Name AR')}}:</label>
																			<input type="text" name="name_ar" value="{{$statu->name_ar}}" class="form-control" >
																		</div>
																		<div class="separator separator-dashed my-5"></div>
																		<div class="form-group">
																			<label>{{__('site.Name EN')}}:</label>
																			<input type="text" name="name_en" value="{{$statu->name_en}}" class="form-control" >
																		</div>
																		<div class="form-group">
																			<label>{{__('site.weight')}}:</label>
																			<input type="number" name="weight" value="{{$statu->weight}}" class="form-control" >
																		</div>
																		<div class="separator separator-dashed my-5"></div>
																		<div class="form-group">
					...
					<div class="offcanvas-content pr-5 mr-n5">
						...
						<div class="d-flex flex-column">
							...
							<div class="navi mt-2">
								<form class="form" method="post" id="new-project" action="{{route('admin.status.index')}}">
									@csrf
										<div class="card-body">
											<div class="form-group">
												<label>{{__('site.Name AR')}}:</label>
