																...
																<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
																	...
																	<!--begin::Group-->
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Show images</button>
																			    @endif
																		...
																		<label class="col-xl-3 col-lg-3 col-form-label">{{__('site.floor_plan')}}</label>
                                                                         <div class="col-lg-9 col-xl-9">
																			...
																			@if(count($data_floorplan)>0)
																				<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal1">Show images</button>
																			    @endif
																			<div class="fv-plugins-message-container"></div>
																		</div>
																	</div>
