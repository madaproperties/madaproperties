...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content" style="padding-top:10px">
									...
									<div class="card-header border-0 py-5">
										<h3 class="card-title align-items-start flex-column">
											<span class="card-label font-weight-bolder text-dark">
											 {{__('site.content')}}</span>
											<span class="text-muted mt-3 font-weight-bold font-size-sm">{{count($status)}} {{__('site.content')}}</span>
										</h3>
										...
										<div class="table-responsive">
									        ...
									        <div class="modal-content">
									            ...
									            <div class="modal-body">
																...
																action="{{route('admin.contents.update',$statu->id)}}">
																	@csrf
																	@method('PUT')
																	<div class="card-body">
					...
					<h3 class="font-weight-bold m-0">New content</h3>
