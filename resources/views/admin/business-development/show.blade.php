				...
				<div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
					<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
						...
						<div class="d-flex align-items-center flex-wrap mr-2">
							<!--begin::Title-->
							<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">{{__('site.Edit Lead')}}</h5>
							<!--end::Title-->
							<!--begin::Separator-->
										...
										<div class="card-body p-0">
											<div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
												<div class="col-xl-12 col-xxl-10">
													<!--begin::Wizard Form-->
													<form class="form fv-plugins-bootstrap fv-plugins-framework" method="post" action="{{route('admin.business-development-leads.update',$business->id)}}" enctype="multipart/form-data">
														@csrf
														@method('PATCH')
														...
														<div class="col-xl-12">
																...
																<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-4 col-xl-4">
																			<input class="form-control form-control-solid form-control-lg" 	name="country" type="text" value="{{$business->country}}" placeholder="{{__('site.country')}}">
																			<div class="fv-plugins-message-container"></div>
																		</div>
																	
																		<label class="col-xl-2 col-lg-2 col-form-label">{{__('site.brand_name')}}</label>
																		<div class="col-lg-4 col-xl-4">
																			<input class="form-control form-control-solid form-control-lg" 	name="brand_name" type="text" value="{{$business->brand_name}}" placeholder="{{__('site.brand_name')}}">
																			<div class="fv-plugins-message-container"></div>
																		</div>
																	</div>
																	<!--end::Group-->
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-4 col-xl-4">
																			<input class="form-control form-control-solid form-control-lg" 	name="activity_name" type="text" value="{{$business->activity_name}}" placeholder="{{__('site.activity')}}">
																			<div class="fv-plugins-message-container"></div>
																		</div>
																		...
																		<div class="col-lg-4 col-xl-4">
																			...
																			<option {{$business->activity_type == '' ? 'selected' : ''}} value="">{{ __('site.choose') }}</option>
																			{!! selectOptions(__('config.activity_type'),$business->activity_type) !!}
																			</select>
																		</div>
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-10 col-xl-10">
																			<input class="form-control form-control-solid form-control-lg" 	name="location" type="text" value="{{$business->location}}" placeholder="{{__('site.location')}}">
																			<div class="fv-plugins-message-container"></div>
																		</div>
															...
															<div class="col-xl-12">
																...
																<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current" >
																	...
																	<div id="contact_html">
																		@php
																			$contact_persons = json_decode($business->contact_persons); 
																			$i=0;
																		@endphp

																		@if($business->contact_persons)
																			...
																			@foreach($contact_persons as $contact_person)
																				<div class="form-group row fv-plugins-icon-container">
																					...
																					<div class="col-lg-4 col-xl-4">
																						<input class="form-control form-control-solid form-control-lg" 	name="contact_persons[{{$i}}][email]" type="email" value="{{$contact_person->email}}" placeholder="{{__('site.email')}}">
																						<div class="fv-plugins-message-container"></div>
																					</div>
																				</div>
																				<div class="form-group row fv-plugins-icon-container">
