										...
										<div class="card-body p-0">
											<div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
												<div class="col-xl-12 col-xxl-10">
													<!--begin::Wizard Form-->
													<form class="form fv-plugins-bootstrap fv-plugins-framework" method="post" action="{{route('admin.business-development-leads.store')}}" id="kt_form" enctype="multipart/form-data">
														@csrf
																...
																<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-4 col-xl-4">
																			...
																			<option {{old('business_category') == '' ? 'selected' : ''}} value="">{{ __('site.choose') }}</option>
																			{!! selectOptions(__('config.business_category'),old('business_category')) !!}
																			</select>
																		</div>
																	</div>
																	<!--end::Group-->
