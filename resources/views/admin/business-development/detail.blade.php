...
<div class="container">
					...
					<!--begin::Profile Overview-->
							<div class="d-flex flex-row">
								...
								<!--begin::Aside-->
									@include('admin.business-development.components.sidebar')
								<!--begin::Content-->
								<div class="flex-row-fluid ml-lg-8">
									...
									<div class="tab-content mt-5" id="myTabContent">
										<div class="tab-pane fade active show" id="activity" role="tabpanel" aria-labelledby="home-tab">
											@include('admin.business-development.components.activities')
										</div>
										<div class="tab-pane fade" id="notes" role="tabpanel" aria-labelledby="notes-tab">
											@include('admin.business-development.components.notes')
										</div>
										<div class="tab-pane fade" id="tasks" role="tabpanel" aria-labelledby="tasks-tab">
											@include('admin.business-development.components.tasks')
										</div>
										...
										aria-labelledby="log-{{strtolower($contact_status)}}-tab">
											@include('admin.business-development.components.logs',['filter' => $contact_status])
										</div>
										@endforeach
										<div class="tab-pane fade" id="requirements" role="tabpanel" aria-labelledby="requirements-tab">
											@include('admin.business-development.components.requirements')
										</div>
		...
		@include('admin.business-development.components.models')
@endsection
@push('js')
