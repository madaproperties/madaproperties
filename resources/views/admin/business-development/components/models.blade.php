        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card card-custom">
                  <!--begin::Form-->
                  <form id="add-task-form" action="{{route('admin.busniess_tasks.store')}}" method="POST">
                    @csrf
                    <div class="card-body">
                      <div>
             ...
             <div class="form-group  fv-plugins-icon-container">
               <label class="">{{__('site.Contact Persons')}}</label>
               <div class="">
                 <select class="form-control"  name="contact_person" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card card-custom">
               <!--begin::Form-->
                 <form id="add-note-form" action="{{route('admin.business_note.store')}}" method="POST">
                   @csrf
                   <input type="hidden" value="{{$business->id}}" name="business_id">
                     <!-- added by fazal -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="card card-custom">
          <!--begin::Form-->
            <form id="add-log-email-form" action="{{route('admin.business_logs.store')}}" method="POST">
              @csrf
				 ...
				 <div class="form-group ">
					<label class="">{{__('site.status')}}</label>
						...
						<select class="form-control"  name="status_id" style="width:100%">
							...
							<option
							{{$business->status_id == $statu->id ? 'selected' : ''}}
					...
					<div class="">
						...
						<option value="">choose</option>
						 @foreach(lead_types() as $lead_type)
							<option
							{{strtolower($business->lead_type) == strtolower($lead_type)  ? 'selected' : ''}}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="card card-custom">
          <!--begin::Form-->
            <form id="add-log-call-form" action="{{route('admin.business_logs.store')}}" method="POST">
              @csrf
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="card card-custom">
          <!--begin::Form-->
            <form id="add-log-meeting-form" action="{{route('admin.business_logs.store')}}" method="POST">
              @csrf
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="card card-custom">
          <!--begin::Form-->
            <form id="add-new-meeting-form" action="{{route('admin.business_logs.store')}}" method="POST">
              @csrf
              <input type="hidden" value="meeting" name="type" />
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="card card-custom">
          <!--begin::Form-->
            <form id="add-log-whatsapp-form" action="{{route('admin.business_logs.store')}}" method="POST">
              @csrf
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="card card-custom">
          <!--begin::Form-->
            <form id="add-requirement-form" action="{{route('admin.business-requirements.store')}}" method="POST">
              @csrf
              <input type="hidden" value="whatsapp" name="type" />
             <div class="card-body">
              <input type="hidden" value="{{$business->id}}" name="business_id">
                  ...
                  <label>{{__('site.contact_person_name')}}</label>
                    <select name="contact_id" class="form-control" >
                      ...
                      @if($business->contact_persons)
                        @foreach($business->contact_persons as $contact_person) 
        ...
        <!--end::Group-->
              <div class="form-group">
                ...
                <select name="business_type" class="form-control" >
                  <option value="">Choose </option>
                {!! selectOptions(__('config.business_types'),old('business_types')) !!}
                </select>
              </div>
              <hr />
              <div class="form-group">
                ...
                <select name="status" class="form-control" required>
                  ...
                  <option value="discussed">{{__('site.closed')}}</option>
                </select>
              </div>
              <div class="form-group">
