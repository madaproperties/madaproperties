        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card card-custom">
                  <!--begin::Form-->
                  <form id="edit-task-form-{{$task->id}}" action="{{route('admin.busniess_tasks.update',$task->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                      <div>
                      ...
                      <hr />
                      <input type="hidden" value="{{$task->business_id}}" name="business_id">
                      <div class="row">
                      ...
                      @if(!isset($busniessdevelopment))
                      <div class="form-group">
                        <label for="task-type">{{__('site.business')}}</label>
                        <div>
                          @php
                            $showRoute = $task->busniessdevelopment ? route('admin.business-development.show',$task->contact->id) : '#';
                          @endphp
                          <a href="{{ $showRoute }}">
                            {{$task->busniessdevelopment ? $task->busniessdevelopment->id : ''}}
                          </a>
                        </div>
                      </div>
                      <hr />
