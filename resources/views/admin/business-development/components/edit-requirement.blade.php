        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card card-custom">
                  <!--begin::Form-->
                  <form id="edit-requirement-form-{{$requirement->id}}" action="{{route('admin.business-requirements.update',$requirement->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                      <div class="row">
                      ...
                      <hr />
                      <input type="hidden" value="{{$requirement->business_id}}" name="business_id">
                      <div class="row">
                        <div class="col-md-6 col-sm-12">
                      ...
                      <hr />
                       <div class="form-group">
                        ...
                        <select name="business_type" class="form-control" required>
                          {!! selectOptions(__('config.business_types'),$requirement->business_type) !!} 
                      ...
                      <div class="form-group">
                        ...
                        <select name="status" class="form-control" required>
                          <option value="">{{__('site.select option')}}</option>
                          <option
                          {{$requirement->status == 'pending' ? 'selected' : '' }}
                          value="pending">{{__('site.pending')}}</option>
                          <option
                          {{$requirement->status == 'discussed' ? 'selected' : '' }}
                          value="discussed">{{__('site.discussed')}}</option>
                        </select>
                      </div>
                      <div class="form-group">
