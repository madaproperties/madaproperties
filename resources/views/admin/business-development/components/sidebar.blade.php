        ...
        <div class="dropdown dropdown-inline">
          ...
          <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
            ...
            <ul class="navi navi-hover ">
              ...
              <li class="navi-item">
                <a href="{{ route('admin.business-development-leads.show',$business->id) }}" class="navi-link">
...
<div class="py-9">
  <div class="d-flex align-items-center justify-content-between mb-2">
    ...
    <span class="text-muted">{{$business->country ? $business->country : 'N/A'}}</span>
  </div>
  <hr />
  <div class="d-flex align-items-center justify-content-between mb-2">
    <span class="font-weight-bold mr-2">{{ __('site.brand_name')}}:</span>
    <span class="text-muted">{{$business->brand_name ? $business->brand_name : 'N/A'}}</span>
  </div>
  <hr />
  <div class="d-flex align-items-center justify-content-between mb-2">
    <span class="font-weight-bold mr-2">{{ __('site.activity_name')}}:</span>
    <span class="text-muted">{{$business->activity_name ? $business->activity_name : 'N/A'}}</span>
  </div>
  <hr />
  <div class="d-flex align-items-center justify-content-between mb-2">
    <span class="font-weight-bold mr-2">{{ __('site.activity_type')}}:</span>
    <span class="text-muted">{{$business->activity_type ? $business->activity_type : 'N/A'}}</span>
  </div>
  <hr />
  <div class="d-flex align-items-center justify-content-between mb-2">
    <span class="font-weight-bold mr-2">{{ __('site.location')}}:</span>
    <span class="text-muted">{{$business->location ? $business->location : 'N/A'}}</span>
  </div>
  <hr />
  @php
    $i=1;
