...
<div class="card card-custom gutter-b">
      ...
      <div class="d-flex">
        ...
        <div class="flex-grow-1">
          ...
          <div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
            ...
            <div class="mr-3">
              ...
              <a href="#" class="d-flex align-items-center text-dark  font-size-h5 font-weight-bold mr-3">
                {{__('site.status')}} : {{$requirement->status}} -  Type :  {{$requirement->business_type}}</a>
              <!--end::Name-->
              <!--begin::Contacts-->
          ...
          <div class="d-flex align-items-center flex-wrap justify-content-between">
            ...
            {{__('site.person_name')}} : {!! $requirement->contact_person?$requirement->contact_person->name : 'N/A'  !!}
            </div>
            <div class="flex-grow-1 font-weight-bold text-dark-50 py-2 py-lg-2 mr-5">
  ...
  @include('admin.business-development.components.edit-requirement')
@endforeach
@push('js')
