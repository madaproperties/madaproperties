										...
										<div class="card-body p-0">
											<div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
												<div class="col-xl-12 col-xxl-10">
													<!--begin::Wizard Form-->
													<form class="form fv-plugins-bootstrap fv-plugins-framework" method="post" action="{{route('admin.project-data.store')}}" id="kt_form"   enctype="multipart/form-data">
														@csrf
														...
														<div class="col-xl-6">
																...
																<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-solid form-control-lg" 	name="city_name" type="text" value="{{old('city_name')}}" placeholder="{{__('site.city_name')}}">
																			<div class="fv-plugins-message-container"></div>
																		</div>
																	</div>
																	<!--end::Group-->
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-solid form-control-lg" 	name="district_name" type="text" value="{{old('district_name')}}" placeholder="{{__('site.district_name')}}">
																			<div class="fv-plugins-message-container"></div>
																		</div>
																	</div>
																	<!--end::Group-->
																		...
																		<div class="col-lg-9 col-xl-9" data-select2-id="38">
																			...
																			name="project_id" data-select2-id="" tabindex="-1" aria-hidden="true">
																				...
																				@foreach($projects as $project)
																					<option {{old('project_id') == $project->id ? 'selected' : ''}} value="{{$project->id}}" data-select2-id="{{$project->id}}">{{$project->name}}</option>
																				@endforeach
																			</select>
																		</div>
																	</div>
																		...
																		<div class="col-lg-9 col-xl-9" data-select2-id="38">
																			...
																			name="developer_id" data-select2-id="" tabindex="-1" aria-hidden="true">
																				...
																				@foreach($developer as $dev)
																					<option {{old('developer_id') == $dev->id ? 'selected' : ''}} value="{{$dev->id}}" data-select2-id="{{$dev->id}}">{{$dev->name}}</option>
																				@endforeach
																			</select>
																		</div>
																	</div>
															...
															<div class="col-xl-6">
																<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-solid form-control-lg" required name="floor_no" type="text" value="{{old('floor_no')}}" placeholder="{{__('site.floor_no')}}">
																			<div class="fv-plugins-message-container"></div>
																		</div>
																	</div>
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<select class="form-control"  name="status">
																				<option {{old('status') == '' ? 'selected' : ''}} value="">{{ __('site.choose') }}</option>
