										...
										<div class="card-body p-0">
											<div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
												<div class="col-xl-12 col-xxl-10">
													<!--begin::Wizard Form-->
													<form class="form fv-plugins-bootstrap fv-plugins-framework" method="post" action="{{route('admin.commercial-leads.update',$commercial->id)}}" enctype="multipart/form-data">
														@csrf
														@method('PATCH')
																...
																<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-4 col-xl-4">
																			...
																			<option {{$commercial->activity_type == '' ? 'selected' : ''}} value="">{{ __('site.choose') }}</option>
