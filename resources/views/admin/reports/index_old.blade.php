  					                  ...
  					                  <div class="form-group ">
  					                     ...
  					                     <div class="">
  					                       <div class="input-group input-group-solid date">
  					                         <input value="{{request('from')}}" required type="date" class="form-control form-control-solid" name="from" >
  					                       </div>
  					                     </div>
  					                   </div>
  					                </div>
  					...
  					<div class="card card-custom gutter-b">
  						...
  						<div class="card-body">
  	                      ...
  	                      @foreach($users as $choosedUser)
  	        								<option {{request('users_id') == $choosedUser->id ? 'selected' : ''}} value="{{$choosedUser->id}}" data-select2-id="{{$choosedUser->id}}">{{$choosedUser->name}}</option>
  	                      @endforeach
          							</select>
													...
													<table class="table" style="background:#f4f4f4">
														...
														<tbody>
															<tr>
																...
																@foreach($status as $state)
																	<th scope="row">
																		<a href="{{route('admin.home')}}?ADVANCED=search&user_id={{$user->id}}&status_id={{$state->id}}&from={{$last14days}}">
																		@php
																...
																@endforeach
																<th>
																	<a href="{{route('admin.home')}}?ADVANCED=search&user_id={{$user->id}}&status_id=&from={{$last14days}}">
																	{{$finalTotal}}
																</th>
