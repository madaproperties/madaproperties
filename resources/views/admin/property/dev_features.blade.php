...
@endpush
    <div class="modal fade" id="features_modal_dev" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-xl">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel"><label>{{__('site.dev_feature')}}</label></h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
                <form method="post" action="{{url('property/save-features')}}" enctype="multipart/form-data" id="dev_features">
                    <div class="modal-body">
                        <div class="form-group">
							@csrf
                            <input type="hidden" name="feature_type" value="2">                            
                            <div class="row col-xl-12">
                                @foreach($devFeatures as $rs)
                                <div class="col-xl-3">
...
@push('js')
    ...
    $(document).ready(function(){
        $("form#dev_features").submit(function(e) {
            e.preventDefault();    
