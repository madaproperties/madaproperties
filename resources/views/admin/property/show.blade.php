																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-11 col-xl-11">
																					@if(request()->get('lang') == 'ar')
																						<input class="form-control form-control-solid form-control-lg" 	name="title_ar" type="text" value="{{$property->title_ar}}" placeholder="{{__('site.title')}}" required>
																					@else
																						<input class="form-control form-control-solid form-control-lg" 	name="title" type="text" value="{{$property->title}}" placeholder="{{__('site.title')}}" required>
																					@endif
