																...
																<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-solid form-control-lg" 	name="title" type="text" value="{{$data->title}}" placeholder="{{__('site.name')}}">
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			@if($data->image)
																				<a href="{{env('APP_URL').'/public/uploads/mada_board/'.$data->image}}" target="_blank" download="download">Download</a>
																				@endif
