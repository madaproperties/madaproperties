									...
									<div class="card card-custom card-shadowless rounded-top-0">
										...
										<div class="card-body p-0">
											<div class="row py-8 px-8 py-lg-15 px-lg-10">
                                              ...
                                              <option {{$employee_leaves->employee_id == $employee->id ? 'selected' : ''}} value="{{$employee->id}}">{{$employee->employee_name}}</option>
																						@endforeach
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" 	name="start_date" value="{{$employee_leaves->start_date}}" type="date" value="{{old('emp_no')}}" >
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<textarea class="form-control form-control-solid form-control-lg" 	name="description"  value="{{old('emp_no')}}">{{$employee_leaves->description}}</textarea>
																					<div class="fv-plugins-message-container"></div>
																				</div>
																			</div>
																	...
																	<div class="col-xl-6">
																		...
																		<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<select class="form-control form-control-solid form-control-lg" name="leave_id">
																						...
																						<option {{$employee_leaves->leave_id == $leave->id ? 'selected' : ''}} value="{{$leave->id}}">{{$leave->leave_name}}</option>
																						@endforeach
																			...
																			<div class="form-group row fv-plugins-icon-container">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" value="{{$employee_leaves->end_date}}" 	name="end_date" type="date">
																				</div>
																			</div>
																			<!--end::Group-->
