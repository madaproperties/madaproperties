														...
														<div class="col-xl-6">
																...
																<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-solid form-control-lg" required	name="unit_name" type="text" value="{{$deal->unit_name}}" placeholder="{{__('site.unit_name')}}">
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-solid form-control-lg" required	name="developer_name" type="text" value="{{$deal->developer_name}}" placeholder="{{__('site.developer_name')}}">
																			<div class="fv-plugins-message-container"></div>
																		</div>
																	</div>
																	<!--end::Group-->
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-solid form-control-lg" required	name="deal_date" type="date" value="{{$deal->deal_date}}" placeholder="{{__('site.deal_date')}}">
																			<div class="fv-plugins-message-container"></div>
																		</div>
																	</div>
																	<!--end::Group-->
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-solid form-control-lg" required	name="client_name" type="text" value="{{$deal->client_name}}" placeholder="{{__('site.client_name')}}">
																			<div class="fv-plugins-message-container"></div>
																		</div>
																	</div>
																	<!--end::Group-->
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-solid form-control-lg" required	name="client_mobile_no" type="text" value="{{$deal->client_mobile_no}}" placeholder="{{__('site.client_mobile_no')}}">
																			<div class="fv-plugins-message-container"></div>
																		</div>
																	</div>
																	<!--end::Group-->
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-solid form-control-lg" id="price" required	name="price" type="text" value="{{$deal->price}}" placeholder="{{__('site.price')}}" autocomplete="off">
																			<div class="fv-plugins-message-container"></div>
																		</div>
																	</div>
																	<!--end::Group-->
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-solid form-control-lg" id="commission" required	name="commission" type="text" value="{{$deal->commission}}" placeholder="{{__('site.commission')}}" autocomplete="off">
																			<div class="fv-plugins-message-container"></div>
																		</div>
																	</div>
																	<!--end::Group-->
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-solid form-control-lg" id="commission_amount" required	name="commission_amount" type="text" value="{{$deal->commission_amount}}" placeholder="{{__('site.commission_amount')}}" readonly>
																			<div class="fv-plugins-message-container"></div>
																		</div>
																	</div>
																	<!--end::Group-->
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-solid form-control-lg" id="vat" required name="vat" type="text" value="{{$deal->vat}}" placeholder="{{__('site.vat')}}">
																			<div class="fv-plugins-message-container"></div>
																		</div>
																	</div>
																	<!--end::Group-->
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-solid form-control-lg" required id="vat_amount" name="vat_amount" type="text" value="{{$deal->vat_amount}}" placeholder="{{__('site.vat_amount')}}" readonly>
																			<div class="fv-plugins-message-container"></div>
																		</div>
																	</div>
																	<!--end::Group-->
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-solid form-control-lg" required id="total_invoice" name="total_invoice" type="text" value="{{$deal->total_invoice}}" placeholder="{{__('site.total_invoice')}}" readonly>
																			<div class="fv-plugins-message-container"></div>
																		</div>
																	</div>
																	<!--end::Group-->
															...
															<div class="col-xl-6">
																...
																<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-solid form-control-lg" type="date" required name="invoice_date" value="{{$deal->invoice_date}}" placeholder="{{__('site.invoice_date')}}">
																			<div class="fv-plugins-message-container"></div>
																		</div>
																	</div>
																	<!--end::Group-->
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-solid form-control-lg" required	name="agent_commission_percent" id="agent_commission_percent" type="text" value="{{$deal->agent_commission_percent}}" placeholder="{{__('site.agent_commission_percent')}}" autocomplete="off">
																			<div class="fv-plugins-message-container"></div>
																		</div>
																	</div>
																	<!--end::Group-->
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-solid form-control-lg" required	name="agent_commission_amount" type="text" value="{{$deal->agent_commission_amount}}" id="agent_commission_amount" placeholder="{{__('site.agent_commission_amount')}}" readonly>
																			<div class="fv-plugins-message-container"></div>
																		</div>
																	</div>
																	<!--end::Group-->
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-solid form-control-lg" id="agent_leader_commission_percent" required	name="agent_leader_commission_percent" type="text" value="{{$deal->agent_leader_commission_percent}}" placeholder="{{__('site.agent_leader_commission_percent')}}" autocomplete="off">
																			<div class="fv-plugins-message-container"></div>
																		</div>
																	</div>
																	<!--end::Group-->
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-solid form-control-lg" required	name="agent_leader_commission_amount" type="text" value="{{$deal->agent_leader_commission_amount}}" id="agent_leader_commission_amount" placeholder="{{__('site.agent_leader_commission_amount')}}" readonly>
																			<div class="fv-plugins-message-container"></div>
																		</div>
																	</div>
																	<!--end::Group-->
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-solid form-control-lg" id="mada_commission" required	name="mada_commission" type="text" value="{{$deal->mada_commission}}" placeholder="{{__('site.mada_commission')}}" readonly> 
																			<div class="fv-plugins-message-container"></div>
																		</div>
																	</div>
																	<!--end::Group-->
																	...
																	<div class="form-group row fv-plugins-icon-container">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<textarea class="form-control form-control-solid form-control-lg" rows="10" name="notes" type="text" id="notes" value="{{old('notes')}}" placeholder="{{__('site.notes')}}">{{$deal->notes}}</textarea>
																			<div class="fv-plugins-message-container"></div>
																		</div>
																	</div>
																	<!--end::Group-->
