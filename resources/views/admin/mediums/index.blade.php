									...
									<div class="card-header border-0 py-5">
										<h3 class="card-title align-items-start flex-column">
											<span class="card-label font-weight-bolder text-dark">
											 {{__('site.medium')}}</span>
											<span class="text-muted mt-3 font-weight-bold font-size-sm">{{count($status)}} {{__('site.medium')}}</span>
										</h3>
 ...
 <!---
									        ...
									        <div class="modal-content">
									            ...
									            <div class="modal-body">
																...
																action="{{route('admin.mediums.update',$statu->id)}}">
																	@csrf
																	@method('PUT')
																	<div class="card-body">
					...
					<h3 class="font-weight-bold m-0">New mediums</h3>
					...
					<div class="offcanvas-content pr-5 mr-n5">
						...
						<div class="d-flex flex-column">
							...
							<div class="navi mt-2">
								...
								action="{{route('admin.mediums.index')}}">
									@csrf
										<div class="card-body">
											<div class="form-group">
												<label>{{__('site.Name')}}:</label>
