...
@endif
    ...
    @endif
				...
				<li class="menu-item menu-item-active" aria-haspopup="true">
					<a
href="{{route('admin.home')}}?filter_status={{ App\Status::where('name_en','new')->first()->id }}" class="menu-link {{ active_nav('admin.home') ? 'active' : ''}}">
	...
	<li class="menu-item menu-item-active text-dark">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          ...
          href="{{route('admin.reports')}}?type=users">users</a>
          <a class="dropdown-item"
          href="{{route('admin.reports')}}?type=report">daily report</a>
    
          <a class="dropdown-item"
          href="{{route('admin.reports')}}?type=campaing">campaign report</a>
        @if(userRole() == 'admin')
          <a class="dropdown-item"
          href="{{route('admin.reports')}}?type=campaing-analytics">campaign analytics</a>
          
          <a class="dropdown-item"
          href="{{route('admin.reports')}}?type=leaders">leaders</a>
      @endif
