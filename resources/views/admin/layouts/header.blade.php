...
<div class="d-none d-lg-flex align-items-center mr-3 navTop_logo">
									...
									@if(userRole() == 'other')
										...
										<a href="{{route('admin.deal.index')}}" class="w-100">
									...
									@else
										...
										<a href="{{route('admin.')}}" class="w-100">
									...
									@endif
										...
										<img alt="Logo" src="{{ asset('public/imgs/mada-logo-blackbg.svg') }}" class="main-logo p-0 mx-auto d-block" />
...
<div class="header-bottom">
						...
						@can('history-list')
							...
							<li class="menu-item menu-item-active {{ request()->routeIs('admin.history.*') ? 'active' : '' }}" aria-haspopup="true">
						...
						@endcan
      					...
      					@if(userRole() == 'admin' OR userRole() == 'manger')
							...
							<li class="menu-item menu-item-active {{ request()->routeIs('admin.statics') ? 'active' : '' }}" aria-haspopup="true">
						...
						<li class="menu-item menu-item-active {{ request()->routeIs('admin.calendar') ? 'active' : '' }}" aria-haspopup="true">
						...
						text-dark">
							...
							<a class="dropdown-item {{(request()->routeIs('admin.users-report')) ? 'active' : '' }}" href="{{route('admin.users-report')}}?type=users">users</a>
							...
							<a class="dropdown-item {{(request()->routeIs('admin.daily-report')) ? 'active' : '' }}" href="{{route('admin.daily-report')}}?type=report"> daily report</a>
							...
							<a class="dropdown-item {{(request()->routeIs('admin.campaign-report')) ? 'active' : '' }}" href="{{route('admin.campaign-report')}}?type=campaing">campaign report</a>
							...
							<a class="dropdown-item {{(request()->routeIs('advance-campaign-report.index')) ? 'active' : '' }}" href="{{route('admin.advance-campaign-report.index')}}">Advance campaign report</a>
							...
							<a class="dropdown-item {{(request()->routeIs('admin.campaign-analytics-report')) ? 'active' : '' }}" href="{{route('admin.campaign-analytics-report')}}?type=campaing-analytics">campaign analytics</a>
							...
							<a class="dropdown-item {{(request()->routeIs('admin.leaders-report')) ? 'active' : '' }}" href="{{route('admin.leaders-report')}}?type=leaders">leaders</a>
						...
						<li class="menu-item menu-item-active text-dark {{ (request()->routeIs('admin.deal.*') || request()->routeIs('admin.deal_project.*')
						...
						<li class="menu-item menu-item-active {{ (request()->routeIs('admin.cash.*')) ? 'active' : '' }}" aria-haspopup="true">
						...
						<li class="menu-item menu-item-active {{ (request()->routeIs('admin.roels.*')) ? 'active' : '' }}" aria-haspopup="true">
						...
						<li class="menu-item menu-item-active text-dark {{ (request()->routeIs('admin.project-data.*') || request()->routeIs('admin.project-name.*')
						...
						<li class="menu-item menu-item-active {{ (request()->routeIs('admin.database-records.*')) ? 'active' : '' }} " aria-haspopup="true">
