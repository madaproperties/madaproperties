<html lang="{{app()->getLocale()}}" dir="{{app()->getLocale() == 'en' ? 'ltr' : 'rtl'}}">
	...
	<body id="kt_body" class=" header-bottom-enabled page-loading">
		...
		<div class="d-flex flex-column flex-root">
			<!--begin::Page-->
			<div class=" flex-column-fluid page">
				<!--begin::Wrapper-->
		...
		@if(false && ($user->can('users-report') || $user->can('daily-report') || $user->can('campaign-report') || $user->can('advance-campaign-report') || $user->can('campaign-analytics-report') || $user->can('leaders-report')))
